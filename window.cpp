...
//auto buttonRestoreView = new QPushButton("\\", right_top_right_frame);
        //fullScreenLayout->addWidget(buttonRestoreView,0,1);
        //buttonRestoreView->setFixedSize(QSize(20,20));
        //connect(buttonRestoreView, &QPushButton::clicked, this, [nested_right_top_layout, stackedWidget, right_top_right_frame](){
        //  nested_right_top_layout->addWidget(right_top_right_frame,1,0);
        //  stackedWidget->setCurrentIndex(0);
        //});
        //
        //
        //setCentralWidget(stackedWidget);
        //auto buttonFullScreen = new QPushButton("\\", right_top_frame);
        //buttonFullScreen->setFixedSize(QSize(20,20));
        //connect(buttonFullScreen, &QPushButton::clicked, this, [fullScreenLayout,stackedWidget, right_top_right_frame](){
        //  fullScreenLayout->addWidget(right_top_right_frame,1,0);
        //  stackedWidget->setCurrentIndex(1);
        //});
        //nested_right_top_layout ->addWidget(buttonFullScreen, 0, 3);